...
namespace Final_Project_Library
{
    class Program
    {
        ...
        public static void Execute(ConsoleKey key)
        {
            ...
            if (key == ConsoleKey.H)
            {
                GameManager.CurrentPlayer.Apply_Power(Power_Type.Healing);
            }
            //------------------------  I = Invisible Power------------------------------
            if (key == ConsoleKey.I)
            {
                GameManager.CurrentPlayer.Apply_Power(Power_Type.Invisible);
            }
            //------------------------  P = Protect Power------------------------------
            if (key == ConsoleKey.P)
            {
                GameManager.CurrentPlayer.Apply_Power(Power_Type.Protect);
            }
            //------------------------  S = Sleepy Power------------------------------
            if (key == ConsoleKey.S)
            {
                GameManager.CurrentPlayer.Apply_Power(Power_Type.Sleepy);
            }
            //------------------------  B = Buy Items------------------------------
            if (key == ConsoleKey.B)
            {
